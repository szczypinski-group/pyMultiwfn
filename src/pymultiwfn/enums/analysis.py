...
class MultiwfnAnalysis:
    ...
    def run_charges(self, verbose: bool = False) -> dict[str, MultiwfnJob]:
        """Run all charge analyses."""
        return self.run_batch(self.CHARGES, verbose)

    def run_bond_orders(self, verbose: bool = False) -> dict[str, MultiwfnJob]:
        """Run all bond order analyses."""
        return self.run_batch(self.BOND_ORDERS, verbose)

    def run_topology(self, verbose: bool = False) -> dict[str, MultiwfnJob]:
    ...
    def run_fuzzy_space(self, verbose: bool = False) -> dict[str, MultiwfnJob]:
        """Run all fuzzy atomic space analyses."""
        return self.run_batch(self.FUZZY_SPACE, verbose)

    def run_eda(self, verbose: bool = False) -> dict[str, MultiwfnJob]:
    ...
    def run_line_plots(self, verbose: bool = False) -> dict[str, MultiwfnJob]:
        """Run all line property plot analyses."""
        return self.run_batch(self.LINE_PLOTS, verbose)

    def run_plane_maps(self, verbose: bool = False) -> dict[str, MultiwfnJob]:
    ...
    def run_all(
        ...
        results: dict[str, dict[str, MultiwfnJob]] = {
