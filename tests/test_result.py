...
class TestMultiwfnResult:
    ...
    @pytest.fixture
    def failed_result(self) -> MultiwfnResult:
    ...
    #     self, failed_result: MultiwfnResult
    # ) -> None:
    #     """Success is False when returncode is non-zero."""
    #     assert failed_result.success is False

    # def test_parse_charges(self, sample_result: MultiwfnResult) -> None:
    ...
    # def test_parse_bond_orders(self, sample_mayer_output: str) -> None:
    ...
    # def test_parse_critical_points(
...
class TestMultiwfnResultGenericParse:
    ...
    # def test_parse_with_parser_name(
    ...
    # def test_parse_unknown_parser(self) -> None:
