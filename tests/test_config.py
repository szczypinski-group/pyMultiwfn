...
class TestMultiwfnConfig:
    ...
    def test_explicit_exe_path_exists(self, mock_executable):
    ...
    def test_explicit_exe_path_not_found(self, temp_dir):
    ...
    def test_executable_cached(self, mock_executable):
    ...
    def test_executable_not_found_anywhere(self, temp_dir, monkeypatch):
...
class TestMultiwfnConfigWithRealExecutable:
    ...
    def test_finds_real_executable(self, real_executable):
    ...
    @pytest.mark.requires_multiwfn
    def test_auto_discovery(self, project_root):
